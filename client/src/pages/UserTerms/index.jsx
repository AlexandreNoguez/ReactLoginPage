...
const UserTerms = () => {
    return (
        <div id="agreement-terms">
            ...
            <p> </p>
            <p>Este documento, e todo o conteúdo do site é oferecido por <strong>Organorepo</strong>, neste termo representado apenas por "EMPRESA", que regulamenta todos os direitos e obrigações com todos que acessam o site, denominado neste termo como "VISITANTE", reguardado todos os direitos previstos na legislação, trazem as cláusulas abaixo como requisito para acesso e visita do mesmo, situado no endereço <strong>http://organorepo.com.(esse site não existe, é apenas um exemplo.)</strong></p>
            <p> </p>
            ...
            <p> </p>
            <p>Este documento, chamado "Termos de Uso", aplicáveis a todos os visitantes do site, foi desenvolvido por Alexandre Advogado - OAB/PI 15.613, modificado com permissão para este site.</p>
            <p> </p>
